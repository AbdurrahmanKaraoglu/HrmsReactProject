        ...
        >
            <form className="updateJobPostingForm">
                ...
                <div className="updateJobPostingItem">
                    ...
                    <div className="updateJobPostingWorkingTypes">

                        <label class="updateJobPostingWorkingTypesContainer">Part Time (Yarı Zamanlı)
                            <input type="checkbox" name="parttime" id="parttime" value="parttime" />
                            <span class="updateJobPostingWorkingTypesCheckmark"></span>
                        </label>
                        <label class="updateJobPostingWorkingTypesContainer">Freelance (Serbest)
                            <input type="checkbox" name="freelance" id="freelance" value="freelance" />
                            <span class="updateJobPostingWorkingTypesCheckmark"></span>
                        </label>
                        <label class="updateJobPostingWorkingTypesContainer">Office (Evden)
                            <input type="checkbox" name="office" id="office" value="office" />
                            <span class="updateJobPostingWorkingTypesCheckmark"></span>
                        </label>
                        <label class="updateJobPostingWorkingTypesContainer">Full Time (Tam Zamanlı)
